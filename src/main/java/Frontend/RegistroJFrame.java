...
package Frontend;
//IMPORTS
import Backend.RegistroUsuario;
...
public class RegistroJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(49, 214, 190, -1));

        jButtonRegistrar.setBackground(new java.awt.Color(178, 143, 96));
        jButtonRegistrar.setFont(new java.awt.Font("Sitka Display", 1, 18)); // NOI18N
        ...
        jPanel1.add(jButtonRegistrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(116, 384, 90, 33));
    ...
    private void jButtonRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegistrarActionPerformed
        ...
        for (Usuario usuario : registroUsuario.getUsuarios()) {
            System.out.println("Nombre: " + usuario.getNombre() + ", Email: " + usuario.getEmail() + ", Contraseña: " + usuario.getPassword());
        }
